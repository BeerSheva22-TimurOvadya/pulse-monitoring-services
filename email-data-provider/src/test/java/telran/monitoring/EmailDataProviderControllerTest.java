...
void serviceMocking() {
	...
	void normalFlow() throws Exception {
		String responseJSON = mockMvc.perform(get("http://localhost:8080/data/" + PATIENT_ID_NORMAL)).andDo(print())
	...
	void abnormalFlow() throws Exception {
		String response = mockMvc.perform(get("http://localhost:8080/data/123")).andDo(print())
