...
public class AvgValuesServiceTest {
	...
	@Test
	void avgValuesTest() {
		assertEquals(AVG_PULSE_VALUE, avgValuesService.getAvgValue(PATIENT_ID, LocalDateTime.now().minusHours(10),
				LocalDateTime.now().plusHours(10)));
		assertEquals(0, avgValuesService.getAvgValue(PATIENT_ID, LocalDateTime.of(2020, 1, 1, 1, 1),
				LocalDateTime.of(2021, 1, 1, 1, 1)));
		assertEquals(VALUE4, avgValuesService.getAvgValue(PATIENT_ID_1, LocalDateTime.now().minusHours(10),
				LocalDateTime.now().plusHours(10)));
	}

	@Test
	void minValuesTest() {
		assertEquals(MIN_PULSE_VALUE, avgValuesService.getMinValue(PATIENT_ID, LocalDateTime.now().minusHours(10),
				LocalDateTime.now().plusHours(10)));
		assertEquals(0, avgValuesService.getMinValue(PATIENT_ID, LocalDateTime.of(2020, 1, 1, 1, 1),
				LocalDateTime.of(2021, 1, 1, 1, 1)));
		assertEquals(VALUE4, avgValuesService.getMinValue(PATIENT_ID_1, LocalDateTime.now().minusHours(10),
				LocalDateTime.now().plusHours(10)));
	}

	@Test
	void maxValuesTest() {
		assertEquals(MAX_PULSE_VALUE, avgValuesService.getMaxValue(PATIENT_ID, LocalDateTime.now().minusHours(10),
				LocalDateTime.now().plusHours(10)));
		assertEquals(0, avgValuesService.getMaxValue(PATIENT_ID, LocalDateTime.of(2020, 1, 1, 1, 1),
				LocalDateTime.of(2021, 1, 1, 1, 1)));
